...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout splashFragment;

  private FragmentSplashBinding(@NonNull LinearLayout rootView,
      @NonNull LinearLayout splashFragment) {
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    LinearLayout splashFragment = (LinearLayout) rootView;

    return new FragmentSplashBinding((LinearLayout) rootView, splashFragment);
  }
}
