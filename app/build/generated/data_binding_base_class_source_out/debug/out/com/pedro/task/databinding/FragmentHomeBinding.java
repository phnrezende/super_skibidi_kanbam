...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  private FragmentHomeBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnLogout,
      @NonNull ConstraintLayout constraintLayout1, @NonNull TabLayout tabs,
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeBinding((LinearLayout) rootView, btnLogout, constraintLayout1, tabs,
          viewPager);
    }
